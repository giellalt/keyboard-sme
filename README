.. -*- mode: rst -*-
=======================================
 Keyboards for the North Sami language
=======================================

This directory contains source files and build instructions for developing
keyboards for the Northern Sami language. The data and implementations
...
* https://giellalt.uit.no/tools/docu-sme-manual.html
...
The Northern Sami keyboard sources can be acquired using the `Giella SVN
